...
4. Fold both into one structured draft review, grouped by severity (Critical/Important), with file:line and a concrete fix suggestion for each finding — explicitly labeled as a draft, not a posted review.
